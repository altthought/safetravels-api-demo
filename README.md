...
This documentation is meant to outline the expected behavior and functionality of our PostgreSQL database as well as our Flask web app. 
...
### Flask Schema --  Administrative Panel
...
#### <i class="icon-file"></i> Creating a User
